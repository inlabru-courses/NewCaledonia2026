...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, boxrule=0pt, enhanced, frame hidden, colback={codebgcolor}, breakable]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
