...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, enhanced, colback={codebgcolor}, boxrule=0pt, sharp corners, breakable]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
