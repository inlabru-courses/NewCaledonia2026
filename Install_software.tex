...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, enhanced, boxrule=0pt, breakable, colback={codebgcolor}, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
