...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, arc=.35mm, coltitle=black, toprule=.15mm, colback=white, bottomtitle=1mm, breakable, toptitle=1mm, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, opacityback=0, title={Task}, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, arc=.35mm, coltitle=black, toprule=.15mm, colback=white, bottomtitle=1mm, breakable, toptitle=1mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, arc=.35mm, coltitle=black, toprule=.15mm, colback=white, bottomtitle=1mm, breakable, toptitle=1mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
