...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, breakable, opacitybacktitle=0.6, title={Task}, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, opacityback=0, arc=.35mm, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, breakable, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, opacityback=0, arc=.35mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, breakable, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, opacityback=0, arc=.35mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm]
